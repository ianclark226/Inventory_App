...
from .serializers import (
    Inventory, InventorySerializer, InventoryGroupSerializer, InventoryGroup, Shop, ShopSerializer, Invoice, InvoiceSerializer, InventoryWithSumSerializer, ShopWithAmountSerializer, InvoiceItem
)
...
class SummaryView(ModelViewSet):
    ...
    permissions_classes = (IsAuthenticatedCustom,)
...
class PurchaseView(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return Response({
            "price": "0.00" if not query.get('amount_total', "0.00") else query.get('amount_total'),
            "count": 0 if not query.get('total', "0.00") else query.get('amount_total'),
        })
